...
local function setup(configs)
    ...
    return {
        ...
        Keyword = { fg = colors.comment, },
        Keywords = { fg = colors.comment, },
        ...
        ['@keyword'] = { fg = colors.comment, },
        ['@keyword.function'] = { fg = colors.comment, },
        ['@keyword.function.ruby'] = { fg = colors.comment, },
        ...
        ['@keyword.include'] = { fg = colors.comment, },
